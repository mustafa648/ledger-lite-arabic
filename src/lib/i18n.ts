...
const ar = {
  ...
  nav: {
    ...
    inventory: "المخزون",
    offlineQueue: "العمليات المعلقة",
  },
  offlineQueue: {
    hint: "الفواتير والسندات التي حُفظت أثناء انقطاع الاتصال. تُرفع تلقائياً عند عودة الإنترنت، ويمكنك إعادة المحاولة أو حذفها يدوياً.",
    empty: "لا توجد عمليات معلقة",
    retry: "إعادة المحاولة",
    retrySuccess: "تمت مزامنة العملية بنجاح",
    retryFailed: "فشلت إعادة المحاولة",
    deleted: "تم حذف العملية المعلقة",
    syncAll: "مزامنة الكل",
    nothingSynced: "لا شيء للمزامنة الآن",
    attempts: "عدد المحاولات: {{count}}",
    status: {
...
const en = {
  ...
  offlineQueue: {
    hint: "Invoices and vouchers saved while offline. They sync automatically when the connection returns; you can also retry or delete them manually.",
    empty: "No pending operations",
    retry: "Retry",
    retrySuccess: "Operation synced",
    retryFailed: "Retry failed",
    deleted: "Pending operation deleted",
    syncAll: "Sync all",
    nothingSynced: "Nothing to sync right now",
